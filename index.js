...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
    ...
    deff.on('qr', () => {
        console.log(color('[','white'), color('!','red'), color(']','white'), color('Scan bang Jan Bengong'))
    })
...
footerText: `No Developer : 082393072006` ,
buttons: buttonss,
headerType: 1
}
